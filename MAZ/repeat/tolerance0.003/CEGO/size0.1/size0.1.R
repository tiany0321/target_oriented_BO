setwd("C:\\Users\\12758\\Desktop\\target_oriented_BO\\MAZ\\repeat\\tolerance0.003\\CEGO\\size0.1")
start_time<-Sys.time()
...
colnames(ave.dis)=c("cego","cego.sd","pre_value","pre_value.sd")
write.csv(ave.dis,"ave.dis.csv")
colnames(ave.OC)=c("cego","cego.sd","pre_value","pre_value.sd")
write.csv(ave.OC,"ave.OC.csv")
colnames(iter_total)=c("cego_u","cego_u.sd","NULL","NULL","NULL","NULL","NULL","NULL")
