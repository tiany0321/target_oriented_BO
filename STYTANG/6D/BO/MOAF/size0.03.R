setwd("C:\\Users\\12758\\Desktop\\target_oriented_BO\\STYTANG\\6D\\BO\\MOAF")
start_time<-Sys.time()
...
fn.utility=function(data.training,estimator,training.data,infj,tar_num){
  ...
  #LCB
  if (estimator==3){ 
    fn.LCB = function(training.data,infj,f=1,delta=0.1)
    {
    ...
    LCB.v= fn.LCB(training.data,infj,f=1,delta=0.1)################parameter delta
