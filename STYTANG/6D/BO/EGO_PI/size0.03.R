setwd("C:\\Users\\12758\\Desktop\\target_oriented_BO\\STYTANG\\6D\\BO\\EGO_PI")
start_time<-Sys.time()
...
ave.OC=matrix(,nrow(iter)-1,8)
ave.dis=matrix(,nrow(iter)-1,8)
...
colnames(ave.dis)=c("ego","ego.sd","PI","PI.sd","LCB","LCB.sd","EQI","EQI.sd")
write.csv(ave.dis,"ave.dis.csv")
colnames(ave.OC)=c("ego","ego.sd","PI","PI.sd","LCB","LCB.sd","EQI","EQI.sd")
write.csv(ave.OC,"ave.OC.csv")
colnames(iter_total)=c("ego","ego.sd","PI","PI.sd","LCB","LCB.sd","EQI","EQI.sd")
